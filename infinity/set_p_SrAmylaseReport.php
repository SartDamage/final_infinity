...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_sr_amylase` (`RegistrationID`, `PatientId`, 
		 `Amalyase`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Amalyase`=:choltrol_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':choltrol', $choltrol, PDO::PARAM_STR);
	$statement->bindParam(':choltrol_dup', $choltrol, PDO::PARAM_STR);
