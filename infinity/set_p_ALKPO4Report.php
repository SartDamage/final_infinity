...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$SAlkalinePhosphatase = $FORM['ctl00_reportmaster_txtSAlkalinePhosphatase'];
    ...
    $statement=$db->prepare("INSERT INTO p_alk_po4 (`RegistrationID`, `PatientId`, 
	
	`S_Alkaline_Phosphatase`,
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			S_Alkaline_Phosphatase=:SAlkalinePhosphatase_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':SAlkalinePhosphatase', $SAlkalinePhosphatase, PDO::PARAM_INT);
	$statement->bindParam(':SAlkalinePhosphatase_dup', $SAlkalinePhosphatase, PDO::PARAM_INT);
