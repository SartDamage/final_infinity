...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_sgot` (`RegistrationID`, `PatientId`, 
		S_G_O_T,
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	S_G_O_T=:Sgot_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':Sgot', $Sgot, PDO::PARAM_INT);
	$statement->bindParam(':Sgot_dup', $Sgot, PDO::PARAM_INT);
