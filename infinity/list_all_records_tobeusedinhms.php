<body style="background-color:#E0F2F1;">
    ...
    <!--  <legend style="color:blue;font-weight:bold;font-size: 12px;">Select Date Range</legend>-->
						...
						<div class="row">
                                ...
                                <div class="col-1">
                                  ...
                                  <label for="from_date" id="date_label" class="col-form-label"><b>From:</b></label>
                                    ...
                                    <div id="datepicker" class="col-3 input-group date">
                                ...
                                <div id="datepicker1" class="col-3 input-group date">
			  ...
			  <table id="myTable" class="table table-striped table-hover dt-responsive nowrap" width="100%">
					<thead class="thead-teal">
						<tr class="head_row">
							...
							<!--<th>Email</th>-->
							<th>Ref by Doctor&nbsp;</th>
							<th class="no-sort"><center>Age & Gender</center></th>
							<th class="no-sort"><center>Diagnosis</center></th>
							<th class="no-sort"><center>DOD & Time</center></th>
							<th class="no-sort"><center>Advance</center></th>
							<th class="no-sort"><center>Balance</center></th>
							<th class="no-sort"><center>Total</center></th>
						</tr>
						</thead>
						<tbody>
						</tbody>
...
$(document).ready(function() {
	...
	var from_date = moment(date1).format("YYYY-MM-DD HH:mm:ss");
 var url="getter/get_dates.php";
 	$.ajax({ url: url,
      ...
      error: function(request, status, error){
   	...
   	function ajaxcall(frmdate,todate){
 var url="getter/get_dates.php";
	$.ajax({ url: url,
				 ...
				 //	/* 'csv','csv', */ 'excel'/* , 'pdf', */, 'print'
										 {
											extend: 'print',
											exportOptions: {
											columns: [1, 2, 3, 4,5,6,7,8] //Your Colume value those you want
													}
												},
												{
														extend: 'excel',
...
<?php
$pageTitle = "List Of All Patients Records"; // Call this in your pages' files to define the page title
