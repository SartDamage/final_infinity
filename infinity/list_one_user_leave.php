			  ...
			  <div class="card-block heading_bar">
				<div class="container">
					<div class="row justify-content-md-center">
						<a class="btn btn-outline-teal" href="/attmanager/apply_holiday.php">Apply holiday</a>
					</div>
				</div>
			  </div>
			</div>
			  ...
			  <table class="table table-striped table-hover" id="myTable">
					<thead class="thead-teal">
						...
						<th class="no-sort">&nbsp;&nbsp;&nbsp;</th>
							...
							<th >From Date</th>
							<th >To date</th>
							<th class="no-sort">Leave reason</th>
...
<script>
	var idfrmgt= <?php echo $userDetails->user_id;?>;
...
/* 					tr.append("<td>" + json[i].contact + "</td>");
					...
					if(json[i].token == 1)
					{
						...
						else if (json[i].token == 2){
							tr.append("<td>Disapproved by Admin</td>");
							}
							else{
				...
				tr.append("<td>Approved</td>");
						...
						elseif(json[i].token == "2")
						{
						tr.append("<td>disapproved</td>");
						
							}
							else{
							      tr.append("<td>Pending approval</td>");
								} */
					//tr.append("<td>" + json[i].token + "</td>");
