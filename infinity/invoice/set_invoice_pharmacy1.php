...
/*	////////////////particulars/////amount
	...
	*/if (($due=="0" ||$due=="0.00" || $due="") && (( $paid!=""||$paid!=null||$paid!="0" || $paid!="0.00" || $paid!="00" || $advance != "0.00" || $advance !="00" || $advance != null)|| $discount!="0" || $discount!="00" ||$discount!="0.00" || $discount != "" ) ){$payment=2;}//complete payment done
    ...
    foreach($FORM["particulars"] as $key => $text_field){
		...
		$state=$db->prepare("INSERT INTO `pharmacy_bill_particulars` ( `reciept_id`,`instance_id`, `Registered_ID`,  `no_of_days`, `particulars`, `amount`, `WhenEntered`, `EnteredBy`) VALUES
		(:RecieptID,:PatID,:RegID,:days,:particulars,:amount,NOW(),:AdminID)
