...
<div class="container print_padding_letterhead" id="reg-form-container" >
  ...
  <div class="card card-outline-info mb-3  do-not-print button_section" style="margin-bottom: 3rem;margin-top: 1rem" id="hide_bar">
...
function parse_individual_particulars(json){
	   ...
	   success: function(data)
	   {
			...
			setValue('due',json[0].due);
			setInnerValue('ctl00_lbltodaydate',(json[0].WhenModified).split(" ")[0].split("-").reverse().join("-").split(" ").join(""));
