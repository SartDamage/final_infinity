	  ...
	  counter++;
        var $template = $('#table_row_template'),
			...
			$clone
				...
				.find('[name="cost[]"]').attr('value', 50).end()
				.find('[name="particulars[]"]').attr('value', 'particulars').end()
...
/* 			$clone
	...
	<form method="post" action="" id="aspnetForm" autocomplete="off">
				...
				<input type="radio" name="gender" id="1radio" value=""> Manual<br>
				<input type="radio" name="gender" id="" value=""> Automatic<br>
