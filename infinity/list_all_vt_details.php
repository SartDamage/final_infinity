...
<body style="background-color:#E0F2F1;">
  <div id="main">
    ...
    <a href="#" onclick="goBack()" class="float" title="Click, to go back">
      ...
      <div class="card card-outline-info mb-12 non-printable" id="topDiv">
     ...
     <div class="printable">
     <h3 style="align:'center">VT Patinet From</h3>
     <br>
      <br>
       </div>
     <div class="card card-outline-info mb-3" id="showvt_block">
        <div class="card-block" id="print">
          ...
          <div class="col-3">
          <input class="form-control noerror" type="text" tabindex="-1"  name="vt_regId" value="" id="vt_regId"  readonly>
          </div>
       ...
       <!-----------------age of last child male---------------------->
        ...
        <div class="form-group row justify-content-center">
         <label for="vt_date" class="col-2 col-form-label required">Date of VL</label>
          <div class="col-3">
         ...
         <div class="form-group row justify-content-center">
           ...
           <div class="form-group row justify-content-md-center non-printable" style="margin-top: 1rem;">
                ...
                <div class="col-md">
                  <input class="form-control btn btn-outline-danger" style="border-color: #dc3545;" type="Submit" title="print" placeholder="Print" onclick="window.print()" name="vt_print" id="vt_print" value="Print">
                </div>
              </div>
            </div>
          </div>
...
var myVar = document.getElementById("tableContent").innerHTML;
myWin = window.open("","print_window","status=1,toolbar=1,height=400,width=600,menubar=1");
myWin.blur();
myWin.document.write('<html><head>'+
'<link rel="stylesheet" type="text/css" href="/includes/styles_print.css"/>'+
'</head><body><div><table>' +
myVar+
'</table></div></body></html>');
myWin.print();
