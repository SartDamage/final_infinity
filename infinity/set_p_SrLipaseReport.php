...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $Amylase_Serum = $FORM['ctl00_reportmaster_txtAmylase'];
    
	$Lipase_Serum = $FORM['ctl00_reportmaster_txtLipase'];
    ...
    $statement=$db->prepare("INSERT INTO p_biochemestry_report_sr_lipase (`RegistrationID`, `PatientId`, 
	
	`Amylase_Serum`,Lipase_Serum,
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Amylase_Serum=:Amylase_Serum_dup,Lipase_Serum=:Lipase_Serum_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':Amylase_Serum', $Amylase_Serum, PDO::PARAM_INT);
	$statement->bindParam(':Amylase_Serum_dup', $Amylase_Serum, PDO::PARAM_INT);
	$statement->bindParam(':Lipase_Serum', $Lipase_Serum, PDO::PARAM_INT);
	$statement->bindParam(':Lipase_Serum_dup', $Lipase_Serum, PDO::PARAM_INT);
