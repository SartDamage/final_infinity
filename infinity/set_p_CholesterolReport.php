...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_sr_cholesterol` (`RegistrationID`, `PatientId`, 
		 `Cholesterol`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Cholesterol`=:Cholesterol_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
