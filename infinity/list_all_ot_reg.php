						...
						<div class="row">
                                ...
                                <div class="col-1">
                                  <label for="from_date" id="date_label" class="col-form-label"><b>From:</b></label>
                                    ...
                                    <input class="" type="text" id="from_date" name="from_date" autocomplete="off" />
                                ...
                                <div id="to_date_div" class="col-3 input-group date">
                                    <input class="" type="text" id="to_date" name="to_date" autocomplete="off"/>
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
...
//to_date="test";
debugger;
var url="<?php echo BASE_URL;?>get_list_all_ot.php";
$.ajax({  url: url,
...
function clickedupdate(e){
    ...
    $("#update_block").show();
    $('html, body').animate({
        scrollTop: $("#update_block").offset().top
    }, 500);
