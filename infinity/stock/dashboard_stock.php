	...
	<div class="container" id="test-form-container" style="padding-left:50px;margin-top:15px;">
		...
		<div class="row justify-content-md-center">
			<div class="col-md-4"><!--Pharmacy-->
				...
				<a class="reset-this" id="addp_stock"  data-toggle="tooltip" data-placement="bottom" title="Add items to stocks" >
				  <div class="card-body">
					<h5 class="card-title">Add Stock<i class="fal fa-plus  pull-right fa-pull-right"  id="ipd_setting" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add new stock"></i></h5>
					<h6 class="card-subtitle mb-2 text-muted">Add Items To Stocks <?php echo date("d-m-Y");?> </h6>
					<!--<p class="card-text">					</p>-->
					<div class="row">
						<div class="col-4">
			...
			<div class="col-md-4"><!--Pharmacy Stock-->
				...
				<a class="reset-this" id="ipd_bed"  data-toggle="tooltip" data-placement="bottom" title="Go to All Stock" >
				  <div class="card-body">
					<h5 class="card-title">List stock<i class="fal fa-plus  pull-right fa-pull-right"  id="ipd_setting" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="List of stock"></i></h5>
					<h6 class="card-subtitle mb-2 text-muted">On : <?php echo date("d-m-Y");?> </h6>
					<!--<p class="card-text">					</p>-->
					<div class="row">
						<div class="col-4">
							<!--<i class="fas fa-prescription-bottle-alt fa-4x"></i>-->
						...
						<?php
							$category = "Pharmacy";
							$db = getDB();
							$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category && number_stock<>'0' ");
							...
							<span class="less_important" id="total_beds" data-toggle="tooltip" data-placement="bottom" title="Total in database">
								<?php
								$category = "Pharmacy";
								$db = getDB();
			...
			<div class="col-md-4"><!--Pharmacy Stock-->
				...
				<a class="reset-this" id="phar_invoice"  data-toggle="tooltip" data-placement="bottom" title="Show Invoice" >
				  <div class="card-body">
					<h5 class="card-title">Pharmacy Invoice<i class="fal fa-plus  pull-right fa-pull-right"  id="ipd_setting" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add Pharmacy Invoice"></i></h5>
					<h6 class="card-subtitle mb-2 text-muted">On : <?php echo date("d-m-Y");?> </h6>
					<!--<p class="card-text">					</p>-->
					<div class="row">
						<div class="col-4">
			...
			<div class="col-md-8"><!--surgical instruments-->
				<div class="card mb-3 pale_red pointer" style="/* width: 18rem; */"  >
					<a class="reset-this" id="low_stock_alert"  data-toggle="tooltip" data-placement="bottom" title="Stock Alert">
						<div class="card-body">
							<h5 class="card-title">Stock Alert <i class="fal fa-plus  pull-right fa-pull-right"  id="add_test" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add new stock"></i></h5>
							<h6 class="card-subtitle mb-2 text-muted"># Low Stock Alert <?php echo date("d-m-Y");?></h6>
							<!--<p class="card-text">					</p>-->
							<div class="row">
								<div class="col-4">
								...
								<div class="col-12">
									...
									<span class="less_important" id="stock_avail" data-toggle="tooltip" data-placement="top" title="">
										<?php
											//$category = "Surgical Instruments";
											$db = getDB();
											$stmt = $db->prepare("SELECT model_no,number_stock FROM `stock_individual` where category=4");
											/*   AND DAY(pr.WhenEntered) = DAY(NOW()) */
											$stmt->execute();
											...
											$lastval="";
											$no="";
											foreach($results as $stockvalue)
											{
											$lastval= $stockvalue['number_stock'];
											
											if($lastval<10)
											{
										            if($no==0)
										             {
										               echo "STOCK IS RUNNING LOW";
													   echo "  ";
										               echo "<i class='fas fa-exclamation-triangle fa-4x pull-right fa-pull-right'></i>";
										                  $no++;
												              }
											...
											if($no==0)
											{
										echo "Sufficient stocks available";
										echo "  ";
										echo "<i class='fas fa-clipboard-check fa-4x pull-right fa-pull-right'></i>";
												}
			...
			<div class="col-md-4"><!--Furniture-->
			<div class="card mb-3 pale_green pointer" style="/* width: 18rem; */"  >
					<a class="reset-this" id="stock_cat"  data-toggle="tooltip" data-placement="bottom" title="Add Category">
						<div class="card-body">
							<h5 class="card-title">Add Category To Stock <i class="fal fa-plus  pull-right fa-pull-right"  id="add_test" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add new Category"></i></h5>
							<h6 class="card-subtitle mb-2 text-muted"># Stock category </h6>
							<!--<p class="card-text">					</p>-->
							<div class="row">
								<div class="col-4">
								...
								<span class="important" id="net_collection"  data-toggle="tooltip" data-placement="bottom" title="Number Of Stock Category"> 
									<?php
											$db = getDB();
											$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category AND number_stock<>'0' ");
											/*   AND DAY(pr.WhenEntered) = DAY(NOW()) */
											$stmt->bindParam(':category',$category, PDO::PARAM_STR);
											$stmt->execute();
											$count=$stmt->rowCount();
			...
			<div class="col-md-4"><!--Furniture-->
				...
				<a id="Stock_type" class="reset-this" data-toggle="tooltip" data-placement="bottom" title="Add Stock Type">
				  <div class="card-body">
					<h5 class="card-title">Add Type To Stock Category<i class="fal fa-plus  pull-right fa-pull-right"  id="add_patient" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add Stock Type"></i></h5>
					<h6 class="card-subtitle mb-2 text-muted">Add Stock Types </h6>
					<!--<p class="card-text">					</p>-->
					<div class="row">
						<div class="col-4">
			...
			<div class="col-md-8"><!--categories-->
				<div class="card mb-3 pale_dirty_brown pointer" style="/* width: 18rem; */">
				<a class="reset-this" id="total_yearly_revenue"  data-toggle="tooltip" data-placement="bottom" title="Go to Invoicing" >
				  <div class="card-body">
					<h5 class="card-title">Categories in stock</h5>
					<h6 class="card-subtitle mb-2 text-muted">all categories of stock in our database</h6><!--."-".substr(date('Y',strtotime('+1 year')), 2,3)-->
					<p class="card-text">					</p>
					<div class="row">
						<div class="col-4">
							<i class="fas fa-container-storage fa-4x "></i>
			...
			<div class="col-md-4"><!--Furniture-->
			<div class="card mb-3 pale_green pointer" style="/* width: 18rem; */"  >
					<a class="reset-this" id="test_reports1"  data-toggle="tooltip" data-placement="bottom" title="View Surgical Item">
						<div class="card-body">
							<h5 class="card-title">Surgical Instruments <i class="fal fa-plus  pull-right fa-pull-right"  id="add_test" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Add new stock"></i></h5>
							<h6 class="card-subtitle mb-2 text-muted"># instruments in hospital <?php echo date("d-m-Y");?></h6>
							<!--<p class="card-text">					</p>-->
							<div class="row">
								<div class="col-4">
								...
								<div class="col-8">
									...
									<span class="important" id="tests_today" data-toggle="tooltip" data-placement="bottom" title="Currently in stock">
										<?php
											$category = "Surgical Instruments";
											$db = getDB();
											$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category AND number_stock<>'0' ");
									...
									<span class="important">/</span>
									<span class="less_important" id="total_tests" data-toggle="tooltip" data-placement="bottom" title="Total in database">
										<?php
											$category = "Surgical Instruments";
											$db = getDB();
											$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category");
			...
			<div class="col-md-4"><!--Furniture-->
				<div class="card mb-3 dirty_ochre pointer" style="/* width: 18rem; */">
				<a id="patient_count" class="reset-this" data-toggle="tooltip" data-placement="bottom" title="go all all stock">
				  <div class="card-body">
					<h5 class="card-title">Furniture<i class="fal fa-plus  pull-right fa-pull-right"  id="add_patient" style="cursor:alias;" data-toggle="tooltip" data-placement="right" title="Register new patient"></i></h5>
					<h6 class="card-subtitle mb-2 text-muted">Furnitures classification on <?php echo date("d-m-Y"); ?></h6>
					<!--<p class="card-text">					</p>-->
					<div class="row">
						<div class="col-4">
						...
						<div class="col-8">
							<span class="important" id="available_bed" data-toggle="tooltip" data-placement="bottom" title="Furniture bed,table,cabinet, etc listed and in stock">
								<?php
											$category = "furniture";
											$db = getDB();
											$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category AND number_stock<>'0' ");
							...
							<span class="important">/</span>
							<span class="less_important" id="total_beds" data-toggle="tooltip" data-placement="bottom" title="Total Furniture Listed">
								<?php
											$category = "furniture";
											$db = getDB();
											$stmt = $db->prepare("SELECT * FROM stock_individual AS SI INNER JOIN stock_category AS SC ON SI.category=SC.ID WHERE SC.category=:category");
...
on_click_redirect('Stock_type','/stock/stock_add_list_type.php');
