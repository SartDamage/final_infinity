...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_cbc`(`RegistrationID`, `PatientId`, `Haemoglobin`, `Rbc_Count`, `Pcv`, `Mcv`, `Mch`, `Mchc`, `Rdw`, `Total_wbc_count`, `Neutrophils`, `Lymphocytes`, `Eosinophils`, `Monocytes`, `Basophils`, `Platelet_count`, `MPV`, `Platelets_on_smear`, `Rbc_morphology`, `Wbcs_on_ps`, `WhenEntered`, `EnteredBy`,`IsActive`) VALUES  (:RegID,:PatID,
