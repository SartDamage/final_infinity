...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$Platelet_Count = $FORM['ctl00_reportmaster_txtHaemoglobin'];
    ...
    $statement=$db->prepare("INSERT INTO p_examination_of_blood_platelet (`RegistrationID`, `PatientId`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Platelet_Count=:Platelet_Count_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':Platelet_Count', $Platelet_Count, PDO::PARAM_INT);
	$statement->bindParam(':Platelet_Count_dup', $Platelet_Count, PDO::PARAM_INT);
