		...
		<br>
			<div class="card card-outline-info mb-3">
			  <div class="card-block heading_bar">
				<h5>List all patients in OPD</h5><a href="#" onclick="goBack()" class="float" title="Click, to go back">
...
//to_date="test";
debugger;
var url="<?php echo BASE_URL;?>get_all_patients_opd.php";
$.ajax({  url: url,
...
<?php
$pageTitle = "OPD Patients List HMS"; // Call this in your pages' files to define the page title
