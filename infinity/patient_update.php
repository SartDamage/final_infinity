...
.form-control:focus {color: #495057;background-color: #fff;border-color: #868e96;outline: 0;box-shadow: 1px 2px 8px 0.2rem #dae0e5;}
...
.form .button_reset:hover, .form .button_reset:active, .form .button_reset:focus {box-shadow: 3px 3px 3px 0.2rem #8c6361;}
.form .seperator{border: 0px;border-bottom: 1px dashed #b5babd;}
...
@media print {.section-to-print, .section-to-print * {visibility: visible;}.section-to-print {position: absolute;left: 0;top: 0;}}
</style>
...
<div class="container" id="reg-form-container" style="padding-left:50px;margin-top:15px;">
	<div class="card card-outline-info mb-3" style="margin-bottom: 6rem!important;">
		...
		<div class="card-block" id="print">
			...
			<form method="post" action="" class="form " name="user_form"  id="pat_update_form" enctype="multipart/form-data">
				<div class="form-group row "><!--name-->
				
				  <label for="regID" id="regID_label" class="col-2 col-form-label ">Reg. ID</label>
				  <div class="col-3">
					<input class="form-control noerror" type="text" placeholder="regID" name="first_name" value="" id="regID"  >
				  </div>
				  <label for="patID" id="patID_label" class="col-2 col-form-label ">Pat. ID</label>
				  <div class="col-3">
					<input class="form-control noerror" type="text" placeholder="patID" name="first_name" value="" id="patID"  >
				  </div>
				</div>
				<div class="form-group row "><!--name-->
				...
				<div class="form-group row"><!--gender--><!--age-->
					...
					<div class="col-3">
						<input class="form-control" type="text" value="" name="gender" id="gender" autocomplete="off"  >
					</div>
...
function parseJsonToForm(json){
		...
		setSelectValue('First-name-input', json.RegistrationID);
