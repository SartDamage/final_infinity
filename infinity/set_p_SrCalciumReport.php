...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $Calcium = $FORM['ctl00_reportmaster_txtCalcium'];
    ...
    $statement=$db->prepare("INSERT INTO `p_sr_calcium` (`RegistrationID`, `PatientId`, 
		 `Calcium`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Calcium`=:Calcium_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':Calcium', $Calcium, PDO::PARAM_STR);
	$statement->bindParam(':Calcium_dup', $Calcium, PDO::PARAM_STR);
