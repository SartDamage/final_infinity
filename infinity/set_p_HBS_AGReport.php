...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO p_hbs_ag (`RegistrationID`, `PatientId`, `Result`, `WhenEntered`, `EnteredBy`, `IsActive`,`Method`) VALUES (:RegID,:PatID,:result,NOW(),:AdminID,'1',:method)
