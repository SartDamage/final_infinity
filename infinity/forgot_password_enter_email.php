...
.header{
	...
	<div class="login-page">
		...
		<br>
		<br>	
		<form class="login-form form" method="post" action="" name="reset" id="reset">
			<div>
				<h4 class="header">Reset Password</h4>
				<br>
			</div>
			<input type="email" placeholder="Enter E-mail" name="usernameEmail" id="usernameEmail" autocomplete="off"/>
			<input type="email" placeholder="Confirm E-mail" name="usernameEmail_cnfrm" id="usernameEmail_cnfrm" autocomplete="off"/>
			<img width="80px;" src="/img/ajax-loader.gif" id="loading_heart" class="img-responsive" />
			<input type="submit" id="button_login" class="button_login" name="loginSubmit" value="Reset Password">
			<p><a href="/index.php" style="color:#8b0000"><i class="fas fa-arrow-alt-left"></i>&nbsp;&nbsp;&nbsp;Login</a></p>
			<div class="errorMsg"><p id="output"></p><p id="output2"></p><p id="output3"></p><p id="output4" style="word-wrap: break-word;"></p><?php echo $errorMsgLogin; ?></div>
		</form>
	</div>
<script src="/dependencies/js/forgot_password_enter_email.js"></script>
<!-- end Login-->
<!--
<div id="signup">
<h3>Registration</h3>
