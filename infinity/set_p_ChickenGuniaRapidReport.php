...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$Chickun_Gunia_IgM = $FORM['ctl00_reportmaster_txtCHICKUNGUNIA'];
    $Sample = $FORM['ctl00_reportmaster_txtSample'];
    ...
    $statement=$db->prepare("INSERT INTO p_chickungunia_rapid (`RegistrationID`, `PatientId`, 
	
	`Chickun_Gunia_IgM`,`Sample`,
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Chickun_Gunia_IgM=:Chickun_Gunia_IgM_dup,Sample=:Sample_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':Chickun_Gunia_IgM', $Chickun_Gunia_IgM, PDO::PARAM_INT);
	$statement->bindParam(':Chickun_Gunia_IgM_dup', $Chickun_Gunia_IgM, PDO::PARAM_INT);
	$statement->bindParam(':Sample', $Sample, PDO::PARAM_INT);
	$statement->bindParam(':Sample_dup', $Sample, PDO::PARAM_INT);
