...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_erythrocyte_sedimentation_rate_esr`(`RegistrationID`, `PatientId`, `Esrendof1hour`, `WhenEntered`, `EnteredBy`,`IsActive`) VALUES  (:RegID,:PatID,
	
	:choltrol,
	
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Esrendof1hour`=:choltrol_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
