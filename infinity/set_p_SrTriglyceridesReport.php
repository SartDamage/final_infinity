...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $Triglycerides = $FORM['ctl00_reportmaster_txtTriglycerides'];
    ...
    $statement=$db->prepare("INSERT INTO `p_sr_triglycerides` (`RegistrationID`, `PatientId`, 
		 `Triglycerides`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Triglycerides`=:Triglycerides_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':Triglycerides', $Triglycerides, PDO::PARAM_INT);
	$statement->bindParam(':Triglycerides_dup', $Triglycerides, PDO::PARAM_INT);
