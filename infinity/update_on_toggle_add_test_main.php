...
if (isset($_GET['value_active'])):
    ...
    $statement=$db->prepare("UPDATE pathologycategorymaster SET IsActive = :quickVar1a,WhenDeactivated=NOW(),DeactivatedBy=:admin_ID where PathologyCategoryID=:pathodrID;"); 
