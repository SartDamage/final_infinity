...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $SputumafbforIday = $FORM['ctl00_reportmaster_txtSputumafbforIday'];
    $SputumafbforIIday = $FORM['ctl00_reportmaster_txtSputumafbforIIday'];
    $SputumafbforIIIday = $FORM['ctl00_reportmaster_txtSputumafbforIIIday'];
    ...
    $statement=$db->prepare("INSERT INTO `p_sputum_afb_3_samples` (`RegistrationID`, `PatientId`, 
		`Sputum_afb_for_1_day`, `Sputum_afb_for_2_day`, `Sputum_afb_for_3_day`, `Interpretation`,
		
		`WhenEntered`, `EnteredBy`,`IsActive`) VALUES  (:RegID,:PatID,
	
	:SputumafbforIday,:SputumafbforIIday,:SputumafbforIIIday,:Interpretation,
	
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	Sputum_afb_for_1_day=:SputumafbforIday_dup,Sputum_afb_for_2_day=:SputumafbforIIday_dup,Sputum_afb_for_3_day=:SputumafbforIIIday_dup,Interpretation=:Interpretation_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':SputumafbforIday', $SputumafbforIday, PDO::PARAM_INT);
	$statement->bindParam(':SputumafbforIday_dup', $SputumafbforIday, PDO::PARAM_INT);
 	$statement->bindParam(':SputumafbforIIday', $SputumafbforIIday, PDO::PARAM_INT);
	$statement->bindParam(':SputumafbforIIday_dup', $SputumafbforIIday, PDO::PARAM_INT);
	$statement->bindParam(':SputumafbforIIIday', $SputumafbforIIIday, PDO::PARAM_INT);
	$statement->bindParam(':SputumafbforIIIday_dup', $SputumafbforIIIday, PDO::PARAM_INT);
