...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
    ...
    $statement=$db->prepare("INSERT INTO `p_malaria_antigen` (`RegistrationID`, `PatientId`, `Result`, `WhenEntered`, `EnteredBy`,`IsActive`) VALUES  (:RegID,:PatID,
	
	:Result,
	
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE	`Result`=:Result_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()");
