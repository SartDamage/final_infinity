...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$Dengue_NS1_Antigen = $FORM['ctl00_reportmaster_txtDengueNS1'];
    ...
    $statement=$db->prepare("INSERT INTO p_dengue_ns1_antigen_test (`RegistrationID`, `PatientId`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Dengue_NS1_Antigen=:Dengue_NS1_Antigen_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':Dengue_NS1_Antigen', $Dengue_NS1_Antigen, PDO::PARAM_STR);
	$statement->bindParam(':Dengue_NS1_Antigen_dup', $Dengue_NS1_Antigen, PDO::PARAM_STR);
