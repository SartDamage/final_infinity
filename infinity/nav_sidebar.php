<nav class="main-menu sidenav" id="mySidenav">
            <ul>
			<li id="avatar">
			<center><label for="fileToUpload1" title="click here to change logo" ><img src="<?php echo $logourl;?>" alt="Avatar" id="test" style="width:130px;cursor: pointer;/*border-radius: 50%;*/" ></label>
				<!--<input id="fileToUpload1" name="fileToUpload1" type="file"  onchange="document.getElementById('test').src = window.URL.createObjectURL(this.files[0])"/>--><!--Shree Gajanan Hospital--></center>
			<!--<hr>-->
			</li>
			<li id="space">
			<br>
...
echo '<li id="Dashboard" name="dashboard" data-toggle="tooltip" title="dashboard">
	...
	?>
            <ul class="logout" id="logout" title="Darstech trading and solution Pvt. Ltd." style="bottom: 6px;position: absolute;" disabled>
				<li>
                   <div  class="pull-right padding" disabled>
						<span class="nav-text" style="font-size:15px;" disabled>				   
                            --HMS By Darstek pvt ltd
						</span>
                    </div>
                </li> 
            </ul>
