...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$LDH = $FORM['ctl00_reportmaster_txtLDH'];
    ...
    $statement=$db->prepare("INSERT INTO p_ldh (`RegistrationID`, `PatientId`, 
	...
	$statement->bindParam(':LDH', $LDH, PDO::PARAM_INT);
	$statement->bindParam(':LDH_dup', $LDH, PDO::PARAM_INT);
