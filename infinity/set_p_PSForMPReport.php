...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $Malarial_parasite = $FORM['ctl00_reportmaster_txtMalarialParasite'];
    ...
    $statement=$db->prepare("INSERT INTO `p_periferal_smear_for_malarial_parasite` (`RegistrationID`, `PatientId`, 
		`Malarial_parasite`,
...
`Malarial_parasite`=:Malarial_parasite_dup,
		
		ModifiedBy=:AdminID_dup,LastModified=NOW()");
	$statement->bindParam(':Malarial_parasite', $Malarial_parasite, PDO::PARAM_STR);
$statement->bindParam(':Malarial_parasite_dup', $Malarial_parasite, PDO::PARAM_STR);
