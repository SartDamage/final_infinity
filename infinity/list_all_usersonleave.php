...
window.addEventListener('DOMContentLoaded', function() {
  console.log('window - DOMContentLoaded - capture'); // 1st
		...
		$.ajax({
			   type: "POST",
			   url: "/attmanager/usersonleavetoday.php",//from global_variable
       ...
       var iconfal="<i class='fas fa-capsules'></i>";
			 ...
			 var iconfal="<i class='fas fa-tablets'></i>";
				 ...
				 var iconfal="<i class='fas fa-user'></i>";
					...
					if(json[i].fromdate==json[i].todate)
					{
...
<?php
$pageTitle = "All staff on leave today"; // Call this in your pages' files to define the page title
