...
input:not([type='submit'],[type='button']), select, summary, textarea {background-color: #fff0!important;border-radius: .25rem;}
...
.float{}
.my-float{}
.break_word{white-space: pre-wrap;word-break: keep-all; /*this stops the word breaking*/}
</style>
	...
	$.ajax({
		   ...
		   success: function(data)
		   {
			  ...
			  //location.href = "./home.php"
					//var json = data;
				//	console.log(json);
				parseJsonToTable_registered_instance(json);/*    in /include/footer    */
				//$value=$value+10;
		 }
...
function parseJsonToform(json){
	...
	console.log("WhenEntered "+json.WhenEntered);
