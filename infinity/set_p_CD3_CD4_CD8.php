...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$CD3_CD4 = $FORM['ctl00_reportmaster_txtCD3'];
    ...
    $statement=$db->prepare("INSERT INTO p_cd3cd4cd8 (`RegistrationID`, `PatientId`, 
	...
	$statement->bindParam(':CD3_CD4', $CD3_CD4, PDO::PARAM_INT);
	$statement->bindParam(':CD3_CD4_dup', $CD3_CD4, PDO::PARAM_INT);
