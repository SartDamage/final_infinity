...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	$FORM = $_GET;
    $PatTime = $FORM['ctl00_reportmaster_txtPatientTime'];
    ...
    $statement=$db->prepare("INSERT INTO p_aptt (`RegistrationID`, `PatientId`, `Patient_time`, `WhenEntered`, `EnteredBy`, `IsActive`) VALUES (:RegID,:PatID,:PatTime,NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Patient_time=:PatTime_dup,ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':PatTime', $PatTime, PDO::PARAM_STR);
	$statement->bindParam(':PatTime_dup', $PatTime, PDO::PARAM_STR);
