...
if (isset($_GET['ctl00_reportmaster_AdminID'])):
	...
	$Sr_prolactin = $FORM['ctl00_reportmaster_txtSrProlactin'];
    ...
    $statement=$db->prepare("INSERT INTO p_prolactine (`RegistrationID`, `PatientId`, 
	...
	NOW(),:AdminID,'1')
		ON DUPLICATE KEY UPDATE 
			Sr_prolactin=:Sr_prolactin_dup, Method=:Method_dup,
			
			ModifiedBy=:AdminID_dup,LastModified=NOW()"); 
	/* $statement->bindParam(':quickVar1a', $quickVar1a, PDO::PARAM_INT); */
	$statement->bindParam(':Sr_prolactin', $Sr_prolactin, PDO::PARAM_INT);
	$statement->bindParam(':Sr_prolactin_dup', $Sr_prolactin, PDO::PARAM_INT);
